...
folders=list.files('Sept2019GrowthExperimentData', full.names=TRUE)

well.label.files=list.files('Sept2019Labels', full.names=TRUE)
...
```{r, warning=FALSE, echo=FALSE, results='hide', fig.keep='none'}
HiDates<-read.csv('HiMRSRDates.csv') 
...
LoDates<-read.csv('LoMRSRDates.csv')
