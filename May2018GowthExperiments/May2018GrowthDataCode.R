...
setwd('/Users/nankabd/Desktop/May2018GrowthAssays')

#write.csv(db, file = 'May2018GrowthData.csv', row.names = F)
...
hi.dates<-read.csv('HiMay2018ExponentialGrowthDates.csv') #dates of exponential growth for each curve
...
lo.dates<-read.csv('LoMay2018ExponentialGrowthDates.csv')
